<div class="container">
	<div class="row">
		<div class="col-xs-12 col-sm-4 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="do_register" autocomplete="off">
				...
				<div class="col-xs-6 col-md-6" ><input type="submit" name="submit" value="Register" class="btn btn-primary btn-block btn-lg" tabnidex="5"></div>
				</div>
			</form>
		</div>
	</div>
